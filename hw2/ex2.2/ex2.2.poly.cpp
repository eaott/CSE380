...
int main() {
	...
	while (std::getline(file, str)) {
		...
		gsl_matrix_set(X, line, 1, r);
		gsl_matrix_set(X, line, 2, r * r);
		gsl_matrix_set(X, line, 3, r * r * r);
		gsl_matrix_set(X, line, 4, r * r * r * r);
		gsl_matrix_set(X, line, 5, r * r * r * r * r);
		gsl_matrix_set(X, line, 6, r * r * r * r * r * r);
